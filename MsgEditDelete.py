...
class MsgEditDelete(commands.Cog):
    ...
    async def on_message_edit(self, before, after):
      ...
      if before.guild.id == 859603774669979648:
        if before.author.bot:
          return
        with open('logchannel.json', 'r', encoding='utf-8') as fp:
          log_channel = json.load(fp)
      ...
      if before.guild.id == 783163340208734208:
        if before.author.bot:
          return
        with open('logchannel.json', 'r', encoding='utf-8') as fp:
          log_channel = json.load(fp)
    ...
    async def on_message_delete(self, message):
      ...
      if message.guild.id == 859603774669979648:
        if message.author.bot:
          return
        with open('logchannel.json', 'r', encoding='utf-8') as fp:
          log_channel = json.load(fp)
      ...
      if message.guild.id == 783163340208734208:
        if message.author.bot:
          return
        with open('logchannel.json', 'r', encoding='utf-8') as fp:
          log_channel = json.load(fp)
