    ...
    async def akinator(self, ctx):
        ...
        try:
            ...
            while aki.progression <= 80:
                ...
                if msg.content.lower() in ["b","back"]:
                    ...
                    try:
                        ...
                        continue
            aki.win()
            answerr=discord.Embed(title=aki.first_guess['name'], description=aki.first_guess['description'],color=0xFFFF00)
            answerr.set_thumbnail(url=aki.first_guess['absolute_picture_path'])
            ...
            if correct.content.lower() == "y":
                ...
                answer = await ctx.send(embed=yes)
                ...
                answer = await ctx.send(embed=no)
                await intromsg.delete()
                await correct.delete()
                await asyncio.sleep(10)
                await answer.delete()
